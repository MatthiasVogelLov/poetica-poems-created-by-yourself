    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container-narrow text-center">
          ...
          <button 
            onClick={goToGenerator}
            className="bg-white text-primary hover:bg-white/90 btn-primary px-8 py-3 text-base"
          >
            Jetzt starten
          </button>
        </div>
...
const FeatureCard = ({ icon: Icon, title, description, delay = 0 }) => (
  <div 
    className="bg-white p-6 rounded-lg shadow-sm border border-border/50 hover:shadow-md transition-all duration-300"
    style={{ 
