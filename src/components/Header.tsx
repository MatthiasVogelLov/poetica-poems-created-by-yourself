  ...
  return (
    ...
    >
      <div className="container-wide flex items-center justify-between">
        <NavLink 
          to="/" 
          className="font-serif text-xl md:text-2xl font-medium transition-all duration-300 hover:opacity-70"
        >
          Poetica
        </NavLink>
        ...
        <div className="hidden md:flex space-x-8 items-center">
          <NavLink 
            to="/"
            className={({ isActive }) => 
              `text-sm tracking-wide transition-all duration-200 hover:text-primary/80 ${
        ...
        <div className="md:hidden absolute top-full left-0 right-0 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md shadow-md animate-fade-in">
          <div className="py-5 px-8 flex flex-col space-y-4">
            <NavLink 
              ...
              className={({ isActive }) => 
                `text-base py-2 transition-all duration-200 ${
                  isActive ? 'text-primary font-medium' : 'text-foreground/80'
                }`
              }
            >
